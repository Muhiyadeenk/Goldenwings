...
const FloatingButtons = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 font-sans">
      ...
      <motion.button 
        onMouseEnter={() => setSeatHovered(true)}
        onMouseLeave={() => setSeatHovered(false)}
      ...
      >
        <div className="w-[52px] h-[52px] flex items-center justify-center flex-shrink-0">
          <Armchair className="w-[22px] h-[22px]" strokeWidth={2.5} />
        </div>
        <AnimatePresence>
          {seatHovered && (
            <motion.span 
              ...
              className="font-bold whitespace-nowrap text-[15px] pr-4"
            >
              Book Your Seat
            </motion.span>
          )}
